	...
	return (
		<>
			...
			<Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 5 }}>
				<Box>
					<Typography variant="h5">Como llegar</Typography>
					<Typography variant="body1">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam omnis, ipsa recusandae officiis
						at maiores porro esse inventore excepturi repellat!
					</Typography>
				</Box>
				<iframe
